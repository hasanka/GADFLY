...
<body style="overflow: hidden" class="dashboard">
	...
	<script type="text/javascript" src="../../javascript/jquery/jquery.superfish.menu.js"></script>
	...
	<!-- shortcuts -->
	<script type="text/javascript" src="../../javascript/dglibs/dg.shortcuts.js"></script>
	<!-- airline javascript logic  -->
	<script type="text/javascript" src="../../private/dashboard/js/dashboard.js"></script>
</body>
</html>
